...
vcom -93 -work work ../../tb_gem_RPM.vhd

# Start the simulator with 1 ns time resolution
vsim -t 1ns -L rtl_work -L work -voptargs="+acc" tb_gem_RPM
